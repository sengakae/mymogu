      ...
      <div className="unlock-box">
        ...
        <form onSubmit={handleSubmit} className="unlock-form">
          <div className="inputs">
            <input type="text" value={codes[0]} onChange={(e) => handleChange(0, e.target.value)} />
          </div>
            ...
            <div className="modal-overlay" onClick={closeModal}>
              <div className="modal-content" onClick={(e) => e.stopPropagation()}>
                ...
                <p className="art-credit">
                  art:{' '}
                  <a href="https://x.com/KunoMD" target="_blank" rel="noopener noreferrer">
                    kunoMD
                  </a>
                </p>
                ...
                <div className="modal-bottom-row">
                  <button
                    ...
                    onClick={() => {
                      ...
                      link.href = imageUrl;
                      link.download =
                        prizeType === 'basic' ? 'mogu_PSG_basic.png' : 'mogu_PSG_secret.png';
                  ...
                  <button className="password-button close-button" onClick={closeModal}>
                    Close
                  </button>
                </div>
              </div>
